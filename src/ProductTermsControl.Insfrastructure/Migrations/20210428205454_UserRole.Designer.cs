...
namespace ProductTermsControl.Insfrastructure.Migrations
{
    ...
    [Migration("20210428205454_UserRole")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductTermsControl.Domain.Entities.BranchProductStock", b =>
                {
                    ...
                    b.Property<int?>("ReasonForOutOfStockId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReasonForOutOfStockId");
            ...
            modelBuilder.Entity("ProductTermsControl.Domain.Entities.ReasonForOutOfStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReasonForOutOfStocks");
                });
            ...
            modelBuilder.Entity("ProductTermsControl.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductTermsControl.Domain.Entities.UserActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductTermsControl.Domain.Entities.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductTermsControl.Domain.Entities.BranchProductStock", b =>
                {
                    ...
                    b.HasOne("ProductTermsControl.Domain.Entities.ReasonForOutOfStock", "ReasonForOutOfStock")
                        .WithMany("BranchProductStocks")
                        .HasForeignKey("ReasonForOutOfStockId");
                });
            ...
            modelBuilder.Entity("ProductTermsControl.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("ProductTermsControl.Domain.Entities.Role", "Roles")
                        .WithMany()
